...
public class OrderItem implements Serializable {
	...
	// OrderItemPK será inserido manualmente
//	public OrderItem(Integer quantity, Double price) {
// Incluido na mao Order e Product
	public OrderItem(Order order, Product product, Integer quantity, Double price) {
		super();
//Inserido na mao o id de Order e Product
		id.setOrder(order);
...
//  EXTERNAMENTE temos que devolver o id Product separadamente
